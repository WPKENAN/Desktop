...
public class Budget extends JFrame
{
    ...
    JTable table=null;
    ResultSet rs=null;
    budgetDao account=new budgetDao();
	...
	String[] Names={"ID","Name","Sum","Bdata"};//创建表格中的横标题
	...
	table.setPreferredScrollableViewportSize(new Dimension(600,300));//  设置此表视口的首选大小
        ...
        b1.addActionListener(new ActionListener() {
           ...
           String fsex=t2.getText();
            ...
            budget md = new budget(fname,fsex,fs);
            int result=account.addBudget(md);
            ...
            //显示成员列表
            dtm.setRowCount(0);
            ResultSet rs=account.getBudget();
            try {
	    while(rs.next()){
	        Vector v=new Vector();
        ...
        b2.addActionListener(new ActionListener() {
            ...
            if(rowcount >= 0)
            {
                ...
                budget md = new budget(s1,s2,s3);
                 int result=account.delBudget(md);
		...
		dtm.addRow(v);
            ...
            public void actionPerformed(ActionEvent e) {
            String s1=JOptionPane.showInputDialog(null, "请输入要修改的名称", null,JOptionPane.PLAIN_MESSAGE);
            String s2=JOptionPane.showInputDialog(null, "请修改名称", null,JOptionPane.PLAIN_MESSAGE);
            String s3=JOptionPane.showInputDialog(null, "请修改预算金额 ", null,JOptionPane.PLAIN_MESSAGE);
            String s4=JOptionPane.showInputDialog(null, "请修改日期 ", null,JOptionPane.PLAIN_MESSAGE);
            int result=account.alterBudget(s1,s2,s3,s4);
